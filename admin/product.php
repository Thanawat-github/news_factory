...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12">
			<a href="index_admin.php?p=proadd" class="pull-right btn btn-primary"><span class="glyphicon glyphicon-plus"></span>+เพิ่มภาพ</a>
		</div>
        <form method="GET" id="form" action="">
            ...
            <div class="col-sm-12">
				...
				<tr>
					...
					<td><?php echo $result["name_slide"];?></td>
					<td><?php echo $result["admin_id"];?></td>
					<td>
					<a class="btn btn-danger btn-sm" href="index_admin.php?p=del_slide&del=<?php echo $result["id_slide"];?>" onclick="return confirm('คุณต้องการลบ <?php echo $result['name_slide'];?> หรือไม่ ?')">
                    ลบ</a>
					</td>
				</tr>	
				<?php
