...
?>
    <center>
        <h4>เพิ่มภาพพื้นวารสาร</h4>
        <div>
            <!--เริ่มฟอร์มของหน้าเพิ่มรายการอาหาร-->
            <div class="container">
                <form method="POST" action="journal_seve.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="name_journal" required>
                            </div>
                        </div>
                    </div>
