                ...
                <form method="POST" action="news_seve.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="hade_news" value="<?php echo $res['hade_news']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="date" class="form-control" name="date_news" value="<?php echo $res['datesave']; ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <textarea  type="text" class="form-control" name="name_news" value="" required><?php echo $res['name_news']; ?></textarea>
                            </div>
                        </div>
                    </div>
